...
def test_edit_request_accepts_file_id_and_image_url_refs():
    ...
    assert dumped["images"][0] == {"file_id": "file-abc123"}
    assert dumped["images"][1] == {
        "image_url": {"url": "https://example.test/input.png"}
    }
...
def test_image_response_serialization_and_usage_placeholder():
    ...
    assert dumped["data"][0]["revised_prompt"] == "a better fox"
    assert dumped["data"][0]["output_format"] == "png"

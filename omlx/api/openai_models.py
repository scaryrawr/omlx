...
class InputVideo(BaseModel):
    ...
    data: str  # Base64-encoded video or data URI
...
class ContentPart(BaseModel):
    ...
    type: str  # "text", "image_url", "video_url", "input_audio", "input_video", or "file"
    text: str | None = None
...
class Usage(BaseUsage):
    ...
    time_to_first_visible_token: float | None = None

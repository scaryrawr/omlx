...
class InputAudio(BaseModel):
    ...
    data: str | None = None  # Base64-encoded audio or data URI
    url: str | None = None  # Internal oMLX extension for file_url passthrough
...
class InputVideo(BaseModel):
    ...
    data: str | None = None  # Base64-encoded video or data URI
    url: str | None = None

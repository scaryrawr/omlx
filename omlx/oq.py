...
def _resolve_mtplx_sidecar(model_path: Path, config: dict) -> Path | None:
...
def import_mtplx_sidecar(model_path: str | Path) -> dict:
...
def _mtp_family_token(config: dict) -> str | None:

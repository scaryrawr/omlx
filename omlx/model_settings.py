...
class ModelSettings:
    ...
    Attributes:
        ...
        mtp_enabled: Enable native multi-token prediction (mlx-lm PR 990 / PR 15 monkey-patch).
            ...
            Multi-row requests use standard batched decoding. Compatible model_types
            include qwen3_5*, qwen3_6*, deepseek_v4*, GLM-5.2, Gemma 4, Inkling,
            Nemotron-H, and Step-3.7. Mutually exclusive with dflash_enabled.
    ...
    cache_reasoning_output: bool | None = (
    ...
    qwen35_ane_prefill_fraction: float | None = None  # Backend default
    ...
    dflash_draft_sink_size: int | None = 0
    ...
    # None = model-specific default (Qwen3.5/3.6 and Qwen4-Exp use their MTP
    # sidecar contract; 3 for DeepSeek-V4).

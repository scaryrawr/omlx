class Omlx < Formula
  ...
  url "https://github.com/jundot/omlx/archive/refs/tags/v0.5.2rc2.tar.gz"
  sha256 "ad600098d899ddbea504d9aca6dc847ad486eb1c3d87574579f6c2617e6f4ac1"
  license "Apache-2.0"
  ...
  # Fetch mlx-audio separately so the formula can install audio support without
  # pulling omlx's optional extras into the core install step.
  resource "mlx-audio" do
    url "https://github.com/Blaizzy/mlx-audio.git",
      revision: "64e8416c303fb3b3463dab8eb4ebd78c55a87c1a"
  end
